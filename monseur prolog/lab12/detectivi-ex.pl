...
suspect2(Nume:Marca:Arma) :- suspect1(Nume:Marca:Arma), findall(N, suspect1(N:Marca:_), L), length(L, S), S > 1.
check8:- tests([
...
suspect3(Nume:Marca:Arma) :- suspect2(Nume:Marca:Arma), findall(N, suspect2(N:_:Arma), L), length(L, S), S > 1.
...
suspect4(Nume:Marca:Arma) :- suspect3(Nume:Marca:Arma), findall(N, suspect3(N:Marca:_), L), length(L, S), S > 1.
...
suspect5(Nume:Marca:Arma) :- suspect4(Nume:Marca:Arma), findall(N, suspect4(N:_:Arma), L), length(L, S), S == 1.
...
suspect6(Nume:Marca:Arma) :- suspect5(Nume:Marca:Arma), findall(N, suspect5(N:Marca:_), L), length(L, S), S == 1.
